...
const PostImages = ({ images }) => {
  ...
  if (images.length === 2) {
    return (
      <>
        <img role="presentation" style={style50} src={`http://localhost:3065/${images[0].src}`} alt={images[0].src} onClick={onZoom} />
        <img role="presentation" style={style50} src={`http://localhost:3065/${images[1].src}`} alt={images[0].src} onClick={onZoom} />
        {showImagesZoom && <ImagesZoom images={images} onClose={onClose} />}
